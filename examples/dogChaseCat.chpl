...
var hundredYardTiler = new LinearTiler(nbins=N_DISTS, x1=0, x2=WORLD_WIDTH+WORLD_HEIGHT, overlap=0.1, wrap=true),
    ...
    cat = new Agent(name="cat", position=new Position(x=150, y=150)),
